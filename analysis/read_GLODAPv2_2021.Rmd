...
rm(xover_subbasin, xover_subbasin_decade, xover_subbasin_decade_stats)
...
```{r cruise_mean_crossover_analysis}
...
```{r cruise_mean_crossover_analysis_NP}
