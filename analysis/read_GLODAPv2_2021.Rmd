...
IO_adj %>%
  ggplot(aes(adj - unadj, offset_mean)) +
  geom_hline(yintercept = 0) +
  geom_vline(xintercept = 0) +
  geom_point(shape = 21) +
  facet_wrap(~ parameter) +
...
IO_adj %>%
  ...
  geom_point(aes(start_date, offset_mean, col = type)) +
  geom_point(aes(start_date, unadj, col = "unadj")) +
  geom_point(aes(start_date, adj, col = "adj")) +
  facet_grid(parameter ~ ., scales = "free_y") +
  labs(y = "Mean xover offset (µmol/kg)") +
  scale_color_brewer(palette = "Set1")
