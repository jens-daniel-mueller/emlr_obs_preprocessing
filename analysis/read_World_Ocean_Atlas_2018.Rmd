...
path_functions <- "/nfs/kryo/work/updata/emlr_cant/functions/"
...
```{r calculate_neutral_density, eval=FALSE}
...
```{r apply_density_threshold, eval=FALSE}
...
```{r write_WOA18_predictor_file, eval=FALSE}
...
```{r neutral_density_surface_WOA18_map, eval=FALSE}
...
```{r neutral_density_sections_WOA18, eval=FALSE}
...
```{r neutral_density_surface_WOA18_map_shallow, eval=FALSE}
...
```{r neutral_density_sections_WOA18_shallow, eval=FALSE}
...
```{r write_WOA18_nuts_O2_predictor_file, eval=FALSE}
